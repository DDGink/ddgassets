...
* 2017 website
**/
$(document).ready(function(){function e(){var e,o;e=document.getElementById("world"),f=new THREE.PerspectiveCamera(75,window.innerWidth/window.innerHeight,1,3e3),f.position.z=1e3,p=new THREE.Scene,g=new THREE.CanvasRenderer({alpha:!0}),g.setPixelRatio(window.devicePixelRatio),g.setSize(window.innerWidth,window.innerHeight),e.appendChild(g.domElement),group=new THREE.Group,p.add(group);var d=2*Math.PI,r=function(e){e.beginPath(),e.arc(0,0,.2,0,d,!0),e.fill()};C=new THREE.SpriteCanvasMaterial({color:16777215,program:r,opacity:.9}),x=new THREE.Geometry;for(var s=0;300>s;s++)o=new THREE.Sprite(C),o.position.x=2e3*Math.random()-1e3,o.position.y=2e3*Math.random()-1e3,o.position.z=2e3*Math.random()-1e3,o.scale.x=o.scale.y=10*Math.random()+4,group.add(o),x.vertices.push(o.position);var l=new THREE.Line(x,new THREE.LineBasicMaterial({color:16777215,opacity:.2}));group.add(l),document.addEventListener("mousemove",i,!1),document.addEventListener("touchstart",a,!1),document.addEventListener("touchmove",n,!1),window.addEventListener("resize",t,!1),$("#world").addClass("ready"),$(".wraplogo").removeClass("hideme")}function t(){y=window.innerWidth/2,H=window.innerHeight/2,f.aspect=window.innerWidth/window.innerHeight,f.updateProjectionMatrix(),g.setSize(window.innerWidth,window.innerHeight)}function i(e){b=e.clientX-y,k=e.clientY-H}function a(e){e.touches.length>1&&(e.preventDefault(),b=e.touches[0].pageX-y,k=e.touches[0].pageY-H)}function n(e){1==e.touches.length&&(e.preventDefault(),b=e.touches[0].pageX-y,k=e.touches[0].pageY-H)}function o(){requestAnimationFrame(o),d()}function d(){f.position.x+=.05*(b-f.position.x),f.position.y+=.05*(-k-f.position.y),f.lookAt(p.position),group.rotation.x+=.001,group.rotation.y-=.001,g.render(p,f)}function r(){var e=!0;W=.02,T+=W,document.addEventListener("mousemove",i,!1),document.addEventListener("touchstart",a,!1),document.addEventListener("touchmove",n,!1),T>.98&&(e=!1,$(".wraplogo").removeClass("hideme"),$(".descubre").on("click",l)),1==e&&(f.fov=R*T,f.updateProjectionMatrix(),requestAnimationFrame(r))}function s(){var e=!0;W=-.02,T+=W,document.removeEventListener("mousemove",i,!1),document.removeEventListener("touchstart",a,!1),document.removeEventListener("touchmove",n,!1),.02>T&&(e=!1,$(L).addClass("show"),"#socials"==L?u():m.fitWidth(),$(".wraplogo").addClass("hidden"),$(".free-wall").addClass("ready"),$(document).on("click",".closeworld",c)),1==e&&(f.fov=R*T,f.updateProjectionMatrix(),requestAnimationFrame(s))}function l(e){L=$(this).data("target")||!1,L!==!1?(e.preventDefault(),$(".descubre").off("click",l),$(".wraplogo").addClass("hideme"),$("#world").addClass("hideme"),s()):console.log("missing data-target")}function c(e){e.preventDefault(),$(document).off("click",".closeworld",c),$(".content").removeClass("show"),$("#world").removeClass("hideme"),$(".wraplogo").removeClass("hidden"),r()}function u(e,t,i,a,n,o){e=e||!1;var d='<div class="flex"><div class="sk-double-bounce"><div class="sk-child sk-double-bounce1"></div><div class="sk-child sk-double-bounce2"></div></div></div>';if($("#socialwall .brick").length){if(e!==!1){$("#socialwall").addClass("ready").removeClass("transition");var a=a||"",n=n||"",o=o||"",t=t||"",i=i||"";$("#socialwall").html(d),$.ajax({method:"POST",cache:!1,url:"site/inc/socials.php",data:{fbnext:t,fbprev:i,first_tweet:a,max_id:n,since_id:o}}).done(function(e){$("#socialwall").html(e),""!==a?h(a):v(),E.fitWidth(),w()})}E.fitWidth()}else $("#socialwall").html(d),$.ajax({url:"site/inc/socials.php",cache:!1}).done(function(e){$("#socialwall").html(e),E.reset({selector:".brick",animate:!0,cellW:200,cellH:"auto",fixSize:0,cacheSize:!1,onResize:function(){E.refresh()}}),E.fitWidth(),w()}).fail(function(e){$("#socialwall").html('<div class="flex closeworld">Connection error, please retry<br><br><i class="fa fa-times"></i><br></div>')})}function v(){$("#twitterindex .active").prev().length?($(".loadmore .loadprev").removeClass("hidden"),$("#twitterindex .active").removeClass("active").prev().addClass("active")):$(".loadmore .loadprev").addClass("hidden")}function h(e){$("#twitterindex").length||$("#socialwall").after('<div id="twitterindex" class="hidden"></div>'),$("#twitterindex .page").removeClass("active"),$("#twitterindex .page-"+e).length?$("#twitterindex .page-"+e).addClass("active"):$("#twitterindex").append('<div class="page active page-'+e+'">'+e+"</div>")}function w(){var e=$("#socialwall .brick .panel:not(.ready)"),t=e.length;$(".loadmore").addClass("ready"),e.each(function(e){var i=$(this);setTimeout(function(){i.addClass("ready"),e+1==t&&E.fitWidth()},200*e)})}var m=new Freewall("#freewall");m.reset({selector:".brick",animate:!0,cellW:300,cellH:"auto",onResize:function(){m.fitWidth()}}),m.container.find(".brick img").on("load",function(){m.fitWidth()});var f,p,g,x,C,E=new Freewall("#socialwall"),b=0,k=0,y=window.innerWidth/2,H=window.innerHeight/2;e(),o();var R=f.fov,T=1,W=-.02,L=!1;$(".descubre").on("click",l);$("#socialwall").on("click",".loadmore .loadnext",function(){var e=$(this).data("fbnext")||!1,t=$(this).data("first_tweet")||!1,i=$(this).data("max_id")||!1;$("#socialwall").addClass("transition").removeClass("ready"),setTimeout(function(){u(!0,e,!1,t,i,"")},300)}),$("#socialwall").on("click",".loadmore .loadprev",function(){var e=$(this).data("fbprev")||!1,t=$(this).data("since_id")||!1,i=$("#twitterindex .active").text();$("#socialwall").addClass("transition").removeClass("ready"),setTimeout(function(){u(!0,!1,e,!1,i,t)},300)});var M=function(){var e=0;return function(t,i){clearTimeout(e),e=setTimeout(t,i)}}();$(document).on("keyup","#search",function(){var e=$(this).val(),t=$("#socialwall .brick.selecta");M(function(){t.each(function(){$(this).text().search(new RegExp(e,"i"))<0?$(this).removeClass("open"):$(this).addClass("open")}),E.filter(".open")},500)})});
